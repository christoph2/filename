...
```python
from filename import build_filename, TimestampPolicy
...
`filename` separates **what** you want to name from **how** you want to name it:
...
```python
from filename import build_filename, CompositePolicy, PrefixPolicy, TimestampPolicy
...
from filename import build_filename, IncrementPolicy
...
```python
from filename import build_filename, MetadataHashPolicy
...
```python
from filename import policy_from_dict, TimestampPolicy
